      ...
      >
        <div className="relative w-full h-full flex flex-col justify-end items-start">
          ...
          <div className="special-p-container">
            ...
            >
              by <a href="https://x.com/marcusquest" target="_blank" rel="noopener noreferrer" className="underline">@marcusquest</a>, <a href="https://x.com/sensho" target="_blank" rel="noopener noreferrer" className="underline">@sensho</a> - <a href="/credits.html" target="_blank" rel="noopener noreferrer" className="underline">more credits</a>
            </p>
          </div>
        </div>
      </div>
