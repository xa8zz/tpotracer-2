      ...
      >
        <div className="relative w-full h-full flex flex-col justify-end items-start">
          ...
          <div className="special-p-container">
            <p className={`absolute bottom-[34px] special-p transition-all duration-300 ease-in-out ${usernameModalVisible ? 'left-[4px]' : 'left-[190px]'}`}>by <a href="https://x.com/marcusquest" target="_blank" rel="noopener noreferrer" className="underline">@marcusquest</a> & <a href="https://x.com/valofpszz" target="_blank" rel="noopener noreferrer" className="underline">@valofpszz</a></p>
