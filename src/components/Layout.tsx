...
const Layout: React.FC<LayoutProps> = ({ children, onUsernameChange, currentUsername }) => {
  ...
  return (
    <div className="flex flex-row h-screen bg-gray-900 text-gray-200 overflow-hidden">
      ...
      <div className="w-80 border-r border-gray-700 overflow-y-auto bg-gray-800 flex flex-col">
        <div className="p-4 border-b border-gray-700 flex justify-between items-center">
          <h2 className="text-xl font-mono font-bold text-gray-100">Leaderboard</h2>
          <button 
